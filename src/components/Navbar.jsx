    ...
    >
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        ...
        >
          ...
          <li>
            <a href="/membership" className="hover:text-[#185a82] transition">
              Membership
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="/blog" className="hover:text-[#185a82] transition">
              Blog
            </a>
          </li>
          <li>
      ...
      {menuOpen && (
        ...
        >
          ...
          <li>
            <a href="/membership" className="block hover:text-[#185a82] transition">
              Membership
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="/blog" className="block hover:text-[#185a82] transition">
              Blog
            </a>
          </li>
          <li>
