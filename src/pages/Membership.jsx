...
export default function Membership() {
    return (
        <div className="bg-[#f9fafa]" style={{ fontFamily: "'Alegreya Sans', sans-serif" }}>
            ...
            <br /><br /><br /><br /><br />
            {/* Hero Section */}
            <section className="pt-28 pb-20 text-center bg-gradient-to-b from-[#9dd5d6] to-[#f9fafa]">
            ...
            {/* Mission Section
            <section className="max-w-5xl mx-auto py-16 px-6 text-center bg-gradient-to-b from-[#9dd5d6] to-[#f9fafa]">
            ...
            {/* Why Join Section */}
            <section className="bg-[#185a82] py-20 px-6 text-center">
                <h2 className="text-3xl font-bold text-[#ffffff] mb-10">Why Join Our Book Club?</h2>
            ...
            {/* How It Works */}
            <section className="bg-[#9dd5d6] py-20 px-6 text-center">
            ...
            {/* Call to Action */}
            <section className="bg-gradient-to-b from-[#9dd5d6] to-[#f9fafa] py-20 text-center">
